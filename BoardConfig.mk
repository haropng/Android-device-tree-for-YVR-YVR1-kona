...
TARGET_KERNEL_SOURCE := kernel/yvr/kona
...
BOARD_SUPER_PARTITION_GROUPS := yvr_dynamic_partitions
BOARD_YVR_DYNAMIC_PARTITIONS_PARTITION_LIST := system product vendor odm
BOARD_YVR_DYNAMIC_PARTITIONS_SIZE := 9122611200 # TODO: Fix hardcoded value
